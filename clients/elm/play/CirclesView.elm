module CirlesView where

import CirclesModel exposing (Cirle, CircleSpec, Position)
import Color exposing (black, red, green)
import Graphics.Collage exposing (circle, collage, filled, move, outlined, rect, solid)
