  ...
  it("you can build an iterable object", function() {
    ...
    var Classroom = function Classroom() {
      for (var students = [],
        ...
        $traceurRuntime.setProperty(students, $__4, arguments[$traceurRuntime.toProperty($__4)]);
        ...
        while (true)
          switch ($ctx.state) {
            ...
            case 2:
              ...
              break;
            case 24:
              $ctx.state = (!($__3 = $__2.next()).done) ? 19 : -2;
              break;
            case 19:
              $ctx.pushTry(17, null);
              $ctx.state = 20;
